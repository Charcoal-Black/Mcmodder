...
export class ConfigLoader {
  static run(cfgutils: McmodderConfigUtils) {
    ...
    .addCheckboxConfig("linkCheck", "资料链接检查", "在资料正文和后台审核中高亮疑似冲突的链接和旧的基于 Fandom 的 Minecraft Wiki 链接。")
    .addCheckboxConfig("linkMark", "资料链接标注", "在启用“资料链接检查”的基础上，在资料正文和后台审核中所有的链接旁标注该链接所指向的 URL。")
