...
export class AdvancementLoader {
  static run(advs: AdvancementUtils) {
    advs
      .add("old_text_word_length_1000", AdvancementType.COMMON, 0, 1, 350, null, null)
      ...
      .add(
        "download_mods_1",
        AdvancementType.SPECIAL,
        12,
        1,
        0,
        Utils.getImageURLByItemID(40221, 128),
        null,
      )
      ...
      .add(
        ...
        3,
        0,
        Utils.getImageURLByItemID(9378, 128),
        null,
      )
      .add(
        "fault_finder",
        ...
        10,
        0,
        Utils.getImageURLByItemID(940, 128),
        null,
      )
      .add(
        "master_editor",
        ...
        1,
        0,
        Utils.getImageURLByItemID(6724, 128),
        null,
      )
      .add(
        ...
        100,
        0,
        "/ueditor/dialogs/emotion/images/mcmod_2020/13.gif",
        null,
      )
      .add(
        "skillful_craftsman",
        ...
        1,
        0,
        Utils.getImageURLByItemID(770349, 128),
        null,
      )
      .add(
        "grave_digger",
        ...
        1,
        0,
        Utils.getImageURLByItemID(72138, 128),
        null,
      )
      .add(
        "all_your_fault",
        ...
        1000,
        0,
        Utils.getImageURLByItemID(37698, 128),
        null,
      )
      .add(
        "so_good_together",
        ...
        1,
        0,
        Utils.getImageURLByItemID(221811, 128),
        null,
      )
      ...
      .addTiered(
        20,
        (tier) => `user_edit_all_${tier}`,
        AdvancementType.COMMON,
        7,
        (tier) => tier * 1e3,
        (tier) => tier * 500,
        null,
      ...
      .addTiered(
        6,
        (tier) => `user_word_avg_${tier}`,
        AdvancementType.COMMON,
        9,
        () => 50,
        (tier) => [192, 669, 585, 942, 1517, 2444][tier - 1],
      )
      .addTiered(
        29,
        (tier) => `user_lv_${tier + 1}`,
        AdvancementType.COMMON,
        21,
        () => 1,
        () => 0,
      ...
      .addTiered(
        5,
        (tier) => `user_edit_today_${tier}`,
        AdvancementType.DAILY,
        27,
        (tier) => [1, 10, 20, 50, 100][tier - 1],
        (tier) => [1, 10, 25, 50, 100][tier - 1],
        null,
        null,
      )
      .addTiered(
        5,
        (tier) => `user_word_today_${tier}`,
        AdvancementType.DAILY,
        28,
        (tier) => [50, 500, 1000, 2500, 5000][tier - 1],
        (tier) => [1, 10, 25, 50, 100][tier - 1],
        null,
        null,
      );
