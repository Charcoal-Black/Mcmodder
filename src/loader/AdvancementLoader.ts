...
export class AdvancementLoader {
  static run(advs: AdvancementUtils) {
    ...
    .add("download_mods_1", AdvancementType.SPECIAL, 12, 1, 0, Utils.getImageURLByItemID(40221, 128), null)
    .add("keep_edit_240days", AdvancementType.SPECIAL, 10, 1, 0, null, null)
    .add("wait_a_minute", AdvancementType.SPECIAL, 13, 3, 0, Utils.getImageURLByItemID(9378, 128), null)
    .add("fault_finder", AdvancementType.SPECIAL, 14, 10, 0, Utils.getImageURLByItemID(940, 128), null)
    .add("master_editor", AdvancementType.SPECIAL, 15, 1, 0, Utils.getImageURLByItemID(6724, 128), null)
    .add("click_girl_100_times", AdvancementType.SPECIAL, 16, 100, 0, "/ueditor/dialogs/emotion/images/mcmod_2020/13.gif", null)
    .add("skillful_craftsman", AdvancementType.SPECIAL, 17, 1, 0, Utils.getImageURLByItemID(770349, 128), null)
    .add("grave_digger", AdvancementType.SPECIAL, 18, 1, 0, Utils.getImageURLByItemID(72138, 128), null)
    .add("all_your_fault", AdvancementType.SPECIAL, 19, 1000, 0, Utils.getImageURLByItemID(37698, 128), null)
    .add("so_good_together", AdvancementType.SPECIAL, 20, 1, 0, Utils.getImageURLByItemID(221811, 128), null)
